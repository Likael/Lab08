...
@Database(entities = {PozycjaMagazynowa.class, HistoriaPozycjiMagazynowej.class}, version = BazaMagazynowa.WERSJA, exportSchema = false)
public abstract class BazaMagazynowa extends RoomDatabase {
    ...
    public abstract HistoriaPozycjiMagazynowejDAO historiaPozycjiMagazynowejDAO();
}
